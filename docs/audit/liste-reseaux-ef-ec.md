...
> Spécification extraite de `audit_technique.xlsx`, onglet « Liste Réseaux EF-EC ».
> 7 cellules, 5 notes.
...
- `G5` **Liste des Réseaux EFS / ECS** — Retour à la page "Partie Technique"  / - Message avertissement enregistrement
...
|---|---|
| `B1` | Audit SOBRIEAU   PARTIE TECHNIQUE |
| `C4` | Liste des Réseaux EFS / ECS |
| `K4` | 1 seule liste pour EF et EC ? |
| `K5` | comment prendre en compte le couplage > même numéro ? |
| `B7` | Numéro |
| `B29` | Remarques |
| `C33` | Enregistrer |
